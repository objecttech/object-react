(ns object-tech.test.contacts.handlers
  (:require [cljs.test :refer-macros [deftest is testing]]
            ...
            object-tech.specs
            object-tech.db
            [object-tech.contacts.events :as contacts-events]
            [object-tech.group.events :as group-events]
            [object-tech.handlers :as handlers]
            object-tech.subs
            [object-tech.utils.js-resources :as js-res]
            [object-tech.utils.datetime :as datetime]))
...
(def wallet-contact
  {:address nil
   :name "Wallet"
   :global-command nil
   :dapp-url "https://object.tech/dapps/wallet/"
   :dapp-hash nil
...
(deftest contacts-events
  "load-contacts
   ...
   add-contact-handler (add-new-contact-and-open-chat, object-tech.contacts.events/add-new-contact,
                        object-tech.contacts.events/send-contact-request ;TODO start-chat)
   ...
   add-contact-handler (add-pending-contact, object-tech.contacts.events/add-new-contact
                        object-tech.contacts.events/send-contact-request ;TODO :discoveries-send-portions)
    ...
    (let [contacts        (rf/subscribe [:get-contacts])
      ...
      (let [new-contact-public-key "0x048f7d5d4bda298447bbb5b021a34832509bd1a8dbe4e06f9b7223d00a59b6dc14f6e142b21d3220ceb3155a6d8f40ec115cd96394d3cc7c55055b433a1758dc74"
        ...
        (testing ":add-contact-handler event - new contact"
          ...
          ;; :object-tech.contacts.events/add-new-contact
          ;; :object-tech.contacts.events/send-contact-request
          ;;TODO :start-chat
