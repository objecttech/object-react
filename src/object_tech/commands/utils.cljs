(ns objecttech.commands.utils
  (:require [clojure.set :as set]
            [clojure.walk :as w]
            [re-frame.core :refer [dispatch trim-v]]
            [objecttech.components.react :as components]
            [objecttech.chat.views.input.web-view :as chat-web-view]
            [objecttech.chat.views.input.validation-messages :as chat-validation-messages]
            [objecttech.chat.views.api.choose-contact :as choose-contact]
            [objecttech.components.qr-code :as qr]
            [objecttech.chat.views.api.geolocation.views :as geolocation]
