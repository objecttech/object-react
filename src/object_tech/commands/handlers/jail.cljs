(ns objecttech.commands.handlers.jail
  (:require [re-frame.core :refer [after dispatch subscribe trim-v debug]]
            [objecttech.utils.handlers :as handlers]
            [objecttech.utils.utils :refer [show-popup]]
            [objecttech.utils.types :refer [json->clj]]
            [objecttech.commands.utils :refer [generate-hiccup reg-handler]]
            [clojure.string :as s]
            [objecttech.components.react :as r]
            [objecttech.models.commands :as cm]
            [objecttech.constants :refer [console-chat-id]]
            [objecttech.i18n :refer [get-contact-translated]]
            [taoensso.timbre :as log]
            [objecttech.commands.utils :as cu]
            [objecttech.data-store.local-storage :as local-storage]))
