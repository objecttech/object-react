(ns objecttech.protocol.core
  (:require objecttech.protocol.message
            ...
            [objecttech.protocol.chat :as chat]
            [objecttech.protocol.group :as group]
            [objecttech.protocol.listeners :as l]
            [objecttech.protocol.encryption :as e]
            [objecttech.protocol.discoveries :as discoveries]
...
(def send-object! discoveries/send-object!)
