(ns objecttech.group.add-contacts.views
  ...
  (:require [re-frame.core :refer [dispatch]]
            ...
            [objecttech.components.contact.contact :refer [toogle-contact-view]]))
