(ns objecttech.group.views
  (:require-macros [objecttech.utils.views :refer [defview letsubs]])
  (:require [re-frame.core :refer [dispatch]]
            [objecttech.contacts.styles :as cstyles]
            [objecttech.components.common.common :as common]
            [objecttech.components.action-button.action-button :refer [action-button action-separator]]
            [objecttech.components.react :refer [view text icon touchable-highlight
