...
(spec/def :contact/object (spec/nilable string?))
...
;true when contact added using object-dev-cli
...
(spec/def :contact/contact (allowed-keys
                             ...
                             :opt-un [:contact/address :contact/private-key :contact/public-key :contact/photo-path
                                      :contact/object :contact/last-updated :contact/last-online :contact/pending?
