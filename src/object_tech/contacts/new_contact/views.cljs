(ns objecttech.contacts.new-contact.views
  ...
  (:require [re-frame.core :refer [dispatch]]
            ...
            [objecttech.components.toolbar.styles :refer [toolbar-title-container
                                                         toolbar-title-text
                                                         toolbar-background1]]
            [objecttech.components.styles :refer [icon-ok button-input-container button-input color-blue]]
            [objecttech.components.image-button.view :refer [scan-button]]
            [objecttech.i18n :refer [label]]
            [cljs.spec.alpha :as s]
            [objecttech.contacts.styles :as st]
            [objecttech.utils.hex :refer [normalize-hex]]
