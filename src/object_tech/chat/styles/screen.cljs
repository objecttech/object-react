(ns objecttech.chat.styles.screen
  (:require-macros [objecttech.utils.styles :refer [defstyle defnstyle]])
  (:require [objecttech.components.styles :refer [chat-background
...
(defn actions-wrapper [object-bar-height]
  {:backgroundColor toolbar-background1
   :elevation       2
   :position        :absolute
   :top             (+ 55 object-bar-height)
   :left            0
   :right           0})
