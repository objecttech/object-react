(ns objecttech.chat.models.input
  (:require [clojure.string :as str]
            [objecttech.components.react :as rc]
            [objecttech.components.object :as object]
            [objecttech.chat.constants :as const]
            [objecttech.chat.views.input.validation-messages :refer [validation-message]]
            [objecttech.i18n :as i18n]
            [objecttech.utils.phone-number :as phone-number]
...
(defn command-completion
  "Returns one of the following values indicating a command's completion object:
