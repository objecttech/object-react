(ns objecttech.chat.views.input.web-view
  (:require-macros [objecttech.utils.views :refer [defview]])
  (:require [reagent.core :as r]
            [re-frame.core :refer [dispatch]]
            [objecttech.components.webview-bridge :refer [webview-bridge]]
            [objecttech.components.react :refer [view text] :as components]
