(ns objecttech.chat.views.api.geolocation.views
  (:require-macros [objecttech.utils.views :refer [defview letsubs]]
                   [reagent.ratom :refer [reaction]])
  (:require [objecttech.components.react :refer [view image text touchable-highlight]]
            [reagent.core :as r]
            [goog.string :as gstr]
            [objecttech.utils.utils :refer [http-get]]
            [objecttech.utils.types :refer [json->clj]]
            [objecttech.chat.views.api.geolocation.styles :as st]
            [objecttech.components.mapbox :refer [mapview]]
