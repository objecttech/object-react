(ns objecttech.discover.styles
  (:require-macros [objecttech.utils.styles :refer [defnstyle]])
  (:require [objecttech.components.styles :refer [color-white
                                                 color-light-gray
                                                 color-blue]]
            [objecttech.components.toolbar.styles :refer [toolbar-background2]]
            [objecttech.components.tabs.styles :as tabs-st]
