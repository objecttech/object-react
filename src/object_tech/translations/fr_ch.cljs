(ns objecttech.translations.fr-ch)
...
(def translations
  {
   ...
   :object-pending                        "En attendant"
   :object-sent                           "Envoyé"
   :object-seen-by-everyone               "Vu par tous"
   :object-seen                           "Vu"
   :object-delivered                      "Livré"
   :object-failed                         "Echoué"
   ...
   :email                                 "E-mail"
   :profile-no-object                     "Pas de statut"
   ...
   :intro-object                          "Chattez avec moi pour configurer votre compte et changer vos paramètres !"
   ...
   :recent                                "Récent"
   :no-objectes-discovered                "Aucun statut trouvé"
   ...
   :debug-enabled                         "Le serveur de débogage a été lancé ! Vous pouvez maintenant ajouter votre Dapp en exécutant *object-dev-cli scan* depuis votre ordinateur"
   ...
   :sign-in-to-object                     "S'identifier vers le statut"
   :got-it                                "J'ai compris"
   ...
   :object-prompt                         "Créez un statut afin d'aider les gens à savoir ce que vous offrez. Vous pouvez également utiliser les #hashtags."
