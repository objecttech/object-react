...
(def translations
  {
   ...
   :camera-access-error                   "Gå venligst til dine systemindstillinger og sørg  for at du Object > Kamera er tilladt."
   :photos-access-error                   "Gå venligst til dine systemindstillinger og sørg  for at du Object > Billeder er tilladt."
   ...
   ;messages
   :object-sending                        "Sender"
   :object-pending                        "Under behandling"
   :object-sent                           "Sendt"
   :object-seen-by-everyone               "Set af alle"
   :object-seen                           "Set"
   :object-delivered                      "Leveret"
   :object-failed                         "Mislykket"
   ...
   :email                                 "Email"
   :update-object                         "Opdater din object..."
   :add-a-object                          "Tilføj en object..."
   :object-prompt                         "Lav en object for at lade folk vide hvad du tilbyder. Du kan også bruge #hashtags."
   :profile-no-object                     "Ingen object"
   ...
   :intro-object                          "Chat med mig for at opsætte din konto og ændre dine indstillinger!!"
   :intro-message1                        "Velkommen til Object\n Tryk på denne meddelelse for at angive din adgangskode og komme i gang!"
   ...
   :recent                                "Seneste"
   :no-objectes-discovered                "Ingen objectser opdaget"
   :no-objectes-found                     "Inger objectser fundet"
   ...
   :password                              "Kodeord"
   :login                                 "Login"
   :sign-in-to-object                     "Log på Object"
   :sign-in                               "Log på"
