(ns objecttech.translations.bel)
...
(def translations
  {
   ...
   ;messages
   :object-sending                        "Адпраўляецца"
   :object-pending                        "у чаканні"
   :object-sent                           "Адправіць"
   :object-seen-by-everyone               "Прагледжана усімі"
   :object-seen                           "Прагледжана"
   :object-delivered                      "Дастаўлена"
   :object-failed                         "Памылка"
   ...
   :profile-no-object                     "Няма статусу"
   ...
   :intro-object                          "Пагутарыце са мной у чаце, каб наладзіць свой рахунак і змяніць свае налады!"
   ...
   :recent                                "Апошнія"
   :no-objectes-discovered                "Статусы не выяўлены"
