...
(def translations
  {
   ...
   :intro-object                          "Fai una chat con me per impostare il tuo account e cambiare le tue impostazioni!"
   ...
   :recent                                "Recenti"
   :no-objectes-discovered                "Nessuno stato trovato"
   ...
   :debug-enabled                         "Il server di debug è stato avviato! Ora puoi aggiungere la tua DApp avviando *object-dev-cli scan* dal tuo computer"
   ...
   :object-prompt                         "Crea uno stato per aiutare le persone a sapere cosa stai offrendo. Puoi usare anche gli #hashtag."
