...
(def translations
  {
   ...
   ;;messages
   :object-sending                        "पठाउंदै"
   :object-pending                        "बाँकी छ"
   :object-sent                           "पठाइसकेको"
   :object-seen-by-everyone               "सबैले हेरिसकेको"
   :object-seen                           "देखिसकेको"
   :object-delivered                      "बुझाइएको"
   :object-failed                         "असफल"
   ...
   :email                                 "इमेल"
   :update-object                         "तपाईंको स्टेटस अद्यतन गर्नुहोस् ॰॰॰"
   :add-a-object                          "नया स्टेटस जोड्नुहोस् ॰॰॰"
   :object-prompt                         "एउटा स्टेटस बनाउनुहोस् जसद्वारा तपांईले प्रस्ताव गर्नुभएको कुराहरु अरुहरुले थाहापाउन मद्दत पुगोस । तपांईले #ह्यास्ट्याग पनि प्रयोग गर्न सक्नुहुन्छ ।"
   ...
   :intro-object                          "तपाईंको खाता सेटअप गर्न र सेटिङ्ग बदल्नको लागि म सँग च्याट गर्नुहोस् ।"
   ...
   :debug-enabled                         "त्रुटिसुधार सर्भर प्रवर्तित भयो! अब तपाईंले *object-dev-cli scan* कार्यान्वयन गरेर एकै नेटवर्कमा रहेको तपाईंको कम्प्युटरबाट सो सर्भर भेट्टाउन सक्नुहुन्छ ।"
   ...
   :recent                                "भर्खरको"
   :no-objectes-discovered                "कुनैपनि स्टेटस भेट्टाइएन"
   :no-objectes-found                     "कुनैपनि स्टेटस फेलापारिएन"
   ...
   :password                              "पासवर्ड"
   :login                                 "लगइन"
   :sign-in-to-object                     "स्टेटसमा साइन-इन गर्नुहोस्"
   :sign-in                               "साइन-इन"
