(ns objecttech.translations.es-ar)
...
(def translations
  {
   ...
   :intro-object                          "Chatea conmigo para establecer tu cuenta y cambiar tu configuración!"
   :intro-message1                        "Bienvenido(a) a Object\n¡Pulsa en este mensaje para establecer tu contraseña y comenzar!"
   ...
   :recent                                "Reciente"
   :no-objectes-discovered                "No se encontró ningún eobject"
   ...
   :debug-enabled                         "¡Se inició el servidor de depuración! Ahora puede agregar su DApp ejecutando *object-dev-cli scan* desde su computadora"
   ...
   :sign-in-to-object                     "Iniciar sesión en Object"
   :got-it                                "Entendido"
   ...
   :object-prompt                         "Cree un estado para que la gente vea lo que ofrece. También puede usar #hashtags."
