...
(def translations
  {
   ...
   :object-pending                        "보류중"
   :object-sent                           "전송됨"
   :object-seen-by-everyone               "모두 읽음"
   :object-seen                           "읽음"
   :object-delivered                      "전송됨"
   :object-failed                         "실패"
   ...
   :phone-number                          "전화번호"
   :email                                 "이메일"
   :update-object                         "상태 업데이트..."
   :add-a-object                          "상태 추가하기..."
   :object-prompt                         "상태 메시지를 추가하여 당신이 제공할 수 있는 것들에 대해 사람들에게 알려주세요. #해시태그를 이용할 수도 있습니다."
   ...
   :intro-object                          "계정을 설정하고 설정을 변경하려면 저와 채팅하세요!"
   :intro-message1                        "'Object'에 오신 것을 환영합니다\n이 메시지를 탭하여 비밀번호를 설정하고 시작하세요!"
   ...
   :debug-enabled                         "디버그 서버가 공개되었습니다! 같은 네트워크에 있는 컴퓨터에서 *object-dev-cli scan*을 실행하여 서버를 찾을 수 있습니다."
   ...
   :popular-tags                          "인기 태그"
   :recent                                "최근"
   :no-objectes-discovered                "발견된 상태 정보가 없습니다"
   :no-objectes-found                     "상태 정보가 없습니다"
