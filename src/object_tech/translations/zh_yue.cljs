(ns objecttech.translations.zh-yue)
...
(def translations
  {
   ...
   :object-pending                        "待定"
   :object-sent                           "發送成功"
   :object-seen-by-everyone               "所有人已讀"
   :object-seen                           "已讀"
   :object-delivered                      "已發送"
   :object-failed                         "失敗"
   ...
   :phone-number                          "電話號碼"
   :email                                 "電郵"
   :update-object                         "更新你的狀態..."
   :add-a-object                          "添加狀態..."
   :object-prompt                         "建立一個狀態以幫助人們了解您提供的內容。 你也可以使用#hashtags。"
   ...
   :intro-object                          "如需設置新帳戶或更改現有設置，請與我聊天！"
   :intro-message1                        "歡迎來到Object\n請點擊此短訊，以設置你的密碼及開始！"
   ...
   :debug-enabled                         "調試服務器已經推出！ 現在你可以執行* object-dev-cli scan *在同一網絡上的電腦上查找服務器。"
   ...
   :popular-tags                          "熱門標籤"
   :recent                                "最近發現"
   :no-objectes-discovered                "沒有發現任何狀態"
   :no-objectes-found                     "找不到狀態"
