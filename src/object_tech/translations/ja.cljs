...
(def translations
  {
   ...
   :object-pending                        "保留中"
   :object-sent                           "送信済み"
   :object-seen-by-everyone               "全員が閲覧"
   :object-seen                           "閲覧"
   :object-delivered                      "配達済み"
   :object-failed                         "失敗しました"
   ...
   :phone-number                          "電話番号"
   :email                                 "メールアドレス"
   :update-object                         "ステータスを更新..."
   :add-a-object                          "ステータスを追加..."
   :object-prompt                         "あなたのオファーを知らせるためにステータスを作成してください。#hashtagsも使用できます。"
   ...
   :intro-object                          "チャットしてアカウントを設定し、設定を変更してください！"
   ...
   :debug-enabled                         "デバッグサーバーを起動しました！ *object-dev-cli scan*を実行すると、同じネットワーク上のコンピュータからサーバーを見つけることができます。"
   ...
   :popular-tags                          "人気のタグ"
   :recent                                "最近"
   :no-objectes-discovered                "ステータスを発見できませんでした"
   :no-objectes-found                     "ステータスが見つかりませんでした"
