...
(def translations
  {
   ...
   ;messages
   :object-sending                        "Pošiljanje"
   :object-pending                        "V teku"
   :object-sent                           "Poslano"
   :object-seen-by-everyone               "Vsi so videli"
   :object-seen                           "Videno"
   :object-delivered                      "Dostavljeno"
   :object-failed                         "Ni uspelo"
   ...
   :email                                 "E-pošta"
   :profile-no-object                     "Brez objecta"
   ...
   :intro-object                          "Klepetaj z mano in nastavi svoj račun ter spremeni svoje nastavitve!"
   :intro-message1                        "Dobrodošel/-la v object\nPritisni to sporočilo in nastavi svoje geslo ter začni!"
   ...
   :recent                                "Nedavno"
   :no-objectes-discovered                "Ni odkritih objectov"
   ...
   :debug-enabled                         "Strežnik za odpravljanje napak je bil zagnan! Sedaj lahko aplikacijo DApp dodate tako, da zaženete *object-dev-cli scan* na vašem računalniku"
   ...
   :sign-in-to-object                     "Prijava v Object"
   :got-it                                "Razumem"
   ...
   :object-prompt                         "Ustvarite object, ki bo drugim nudil več informacij o stvareh, ki jih nudite. Uporabljate lahko tudi #hashtage."
   :add-a-object                          "Dodaj object..."
   :error                                 "Napaka"
   :edit-contacts                         "Urejanje stikov"
   :more                                  "več"
   :cancel                                "Prekliči"
   :no-objectes-found                     "Ni objectov"
