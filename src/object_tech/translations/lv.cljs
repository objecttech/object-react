...
(def translations
  {
   ...
   :camera-access-error                   "Kļūda, nav atļaujas piekļūt kamerai. Lūdzu, iestatījumos pārliecinies, ka  Object > Camera ir izvēlēts."
   :photos-access-error                   "Kļūda, nav atļaujas piekļūt fotogrāfijām. Lūdzu, iestatījumos pārliecinies, ka Object > Photos ir izvēlēts."
   ...
   ;messages
   :object-sending                        "Sūta"
   :object-pending                        "Neizlemts"
   :object-sent                           "Aizsūtīts"
   :object-seen-by-everyone               "Apskatīts"
   :object-seen                           "Apskatīts"
   :object-delivered                      "Piegādāts"
   :object-failed                         "Neizdevās"
   ...
   :email                                 "E-pasts"
   :update-object                         "Rediģēt aprakstu..."
   :add-a-object                          "Pievienot aprakstu..."
   :object-prompt                         "Pievieno aprakstu lai cilvēki zinātu ko tu piedāvā. Tu vari arī izlietot #hashtagus."
   ...
   :intro-object                          "Čato ar mani, ja gribi mainīt ustatījumus!"
   ...
   :debug-enabled                         "Debug serveris startēja! Tu vari izlietot *object-dev-cli scan* lai atrastu serveri."
   ...
   :password                              "Parole"
   :login                                 "Lietotājvārds"
   :sign-in-to-object                     "Ieiet Object"
   :sign-in                               "Ieiet"
