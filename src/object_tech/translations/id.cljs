...
(def translations
  {
   ...
   ;messages
   :object-sending                        "mengirim"
   :object-pending                        "pending"
   :object-sent                           "dikirim"
   :object-seen-by-everyone               "terlihat oleh semua"
   :object-seen                           "terlihat"
   :object-delivered                      "terkirim"
   :object-failed                         "gagal"
   ...
   :email                                 "email"
   :profile-no-object                     "tidak ada informasi object"
   ...
   :intro-object                          "berbicara dengan saya untuk mengatur akun Anda dan mengubah pengaturan Anda!"
   :intro-message1                        "selamat datang di Object \n klik pesan ini untuk mengatur sandi Anda & memulai!"
   ...
   :recent                                "terbaru"
   :no-objectes-discovered                "informasi object tidak ditemukan"
