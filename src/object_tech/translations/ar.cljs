...
(def translations
  {
   ...
   ;messages
   :object-sending                        "إرسال"
   :object-pending                        "ريثما"
   :object-sent                           "تم الإرسال"
   :object-seen-by-everyone               "شوهد من قبل الجميع"
   :object-seen                           "شوهد"
   :object-delivered                      "تم الاستلام"
   :object-failed                         "فشل"
   ...
   :profile-no-object                     "لا توجد حالة"
   ...
   :intro-object                          "دردش معي لتثبيت حسابك وقم بتغيير الإعدادات الخاصة بك!"
   :intro-message1                        "مرحبا بك في Object \n اضغط على هذه الرسالة لتعيين كلمة المرور الخاصة بك وابدأ!"
   ...
   :recent                                "حديثة"
   :no-objectes-discovered                "لم يتم الكشف عن حالات"
