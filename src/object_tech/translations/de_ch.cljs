(ns objecttech.translations.de-ch)
...
(def translations
  {
   ...
   ;messages
   :object-sending                        "Senden"
   :object-pending                        "Anhängig"
   :object-sent                           "Gesendet"
   :object-seen-by-everyone               "Von allen gesehen"
   :object-seen                           "Gesehen"
   :object-delivered                      "Geliefert"
   ...
   :intro-object                          "Chat mit mir, damit ich dein Konto einrichten und deine Einstellungen ändern kann!"
   :intro-message1                        "Willkommen zu Object\nTap diese Nachricht um dein Passwort einzurichten & loszulegen!"
   ...
   :recent                                "Kürzlich"
   :no-objectes-discovered                "Es wurden keine Object gefunden"
