...
(def translations
  {
   ...
   ;messages
   :object-sending                        "Gönderiliyor..."
   :object-pending                        "Beklemede"
   :object-sent                           "Gönderildi"
   :object-seen-by-everyone               "Herkes tarafından görüldü"
   :object-seen                           "Görüldü"
   :object-delivered                      "Teslim edildi"
   :object-failed                         "Başarısız"
   ...
   :intro-object                          "Hesabınızı kurmak ve ayarlarınızı değiştirmek için benimle sohbet edin!"
   :intro-message1                        "Object'e hoş geldiniz\nŞifrenizi oluşturmak ve hemen başlamak için bu mesaja dokunun!"
   ...
   :recent                                "Güncel"
   :no-objectes-discovered                "Herhangi bir durum keşfedilmedi"
   ...
   :debug-enabled                         "Hata ayıklama sunucusu başlatıldı! Artık şimdi bilgisayarınızdan *object-dev-cli scan* çalıştırarak DApp'inizi ekleyebilirsiniz"
   ...
   :sign-in-to-object                     "Durumlar için oturum açın"
   :got-it                                "Anladım"
   ...
   :transaction                           "İşlem"
   :public-group-object                   "Herkese açık"
   ...
   :object-prompt                         "Sunduğunuz şeyler hakkında insanlara yardımcı olması için bir durum oluşturun. #hashtag de kullanabilirsiniz."
   :add-a-object                          "Durum ekleyin..."
   :error                                 "Hata"
   :edit-contacts                         "Kişileri düzenleyin"
   :more                                  "dahası"
   :cancel                                "İptal Et"
   :no-objectes-found                     "Durum bulunamadı"
   :swow-qr                               "QR Göster"
