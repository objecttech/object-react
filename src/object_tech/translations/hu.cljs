...
(def translations
  {
   ...
   ;messages
   :object-sending                        "Küldés"
   :object-pending                        "Függőben levő"
   :object-sent                           "Elküldve"
   :object-seen-by-everyone               "Látva mindenki által"
   :object-seen                           "Látva"
   :object-delivered                      "Kézbesítve"
   :object-failed                         "Nem sikerült"
   ...
   :email                                 "E-mail"
   :profile-no-object                     "Nincs állapot"
   ...
   :intro-object                          "Csevegj velem felhasználói fiókod létrehozásáról és beállításaid megváltoztatásáról!"
   ...
   :recent                                "Legutóbbi"
   :no-objectes-discovered                "Nincsenek felfedezett állapotok"
   ...
   :debug-enabled                         "A hibakereső szerver elindításra került! Mostantól hozzáadhatod a DAppod, ha futtatod a számítógépeden a következőt: *object-dev-cli scan*"
   ...
   :sign-in-to-object                     "Bejelentkezés Állapot megosztásához"
   :got-it                                "Értem"
   ...
   :object-prompt                         "Hozz létre egy állapotot és segíts az embereknek, hogy megismerjék az általad kínált dolgokat. Használhatsz #hashtageket is."
   :add-a-object                          "Állapot hozzáadása..."
   :error                                 "Hiba"
   :edit-contacts                         "Névjegyek szerkesztése"
   :more                                  "több"
   :cancel                                "Mégse"
   :no-objectes-found                     "Nem található állapot"
