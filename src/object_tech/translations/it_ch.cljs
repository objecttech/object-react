(ns objecttech.translations.it-ch)
...
(def translations
  {
   ...
   ;messages
   :object-sending                        "Invio in corso"
   :object-pending                        "In attesa di"
   :object-sent                           "Inviato"
   :object-seen-by-everyone               "Visto da tutti"
   :object-seen                           "Visto"
   :object-delivered                      "Consegnato"
   :object-failed                         "Invio fallito"
   ...
   :email                                 "Email"
   :profile-no-object                     "Nessuno stato"
   ...
   :intro-object                          "Avvia una conversazione con me per impostare il tuo conto e modificare le tue impostazioni!"
   :intro-message1                        "Benvenuto su Object\nTocca questo messaggio per impostare la tua password e iniziare!"
   ...
   :recent                                "Recente"
   :no-objectes-discovered                "Nessuno stato identificato"
   ...
   :debug-enabled                         "Il server di debug è stato avviato! Ora puoi aggiungere la tua DApp eseguendo *object-dev-cli scan* dal tuo computer"
   ...
   :sign-in-to-object                     "Accedi a Stato"
   :got-it                                "OK"
   ...
   :object-prompt                         "Crea uno stato per consentire le persone di conoscere le cose che offri. Puoi usare anche gli #hashtag"
   :add-a-object                          "Aggiungi uno stato…"
   :error                                 "Errore"
   :edit-contacts                         "Modifica contatti"
   :more                                  "altro"
   :cancel                                "Annulla"
   :no-objectes-found                     "Nessuno stato trovato"
   :swow-qr                               "Mostra QR"
