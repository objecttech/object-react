...
(def translations
  {
   ...
   :intro-object                          "¡Habla conmigo para configurar tu cuenta y cambiar tu configuración!"
   :intro-message1                        "Bienvenido a Object\n¡Toca este mensaje para configurar tu contraseña y empezar!"
   ...
   :recent                                "Reciente"
   :no-objectes-discovered                "No se han encontrado Object"
   ...
   :debug-enabled                         "¡El servidor de depuración se ha puesto en marcha! Ahora puede añadir su DApp ejecutando *object-dev-cli scan* desde su ordenador"
   ...
   :sign-in-to-object                     "Registrarse en Estado"
   :got-it                                "Entendido"
   ...
   :object-prompt                         "Cree un estado para ayudar a la gente a conocer las cosas que está ofreciendo. También puede usar #hashtags."
   :add-a-object                          "Añadir un estado..."
   :error                                 "Error"
   :edit-contacts                         "Editar contactos"
   :more                                  "más"
   :cancel                                "Cancelar"
   :no-objectes-found                     "No se han encontrado estados"
   :swow-qr                               "Mostrar QR"
