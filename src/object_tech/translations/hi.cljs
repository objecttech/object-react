...
(def translations
  {
   ...
   ;messages
   :object-sending                        "भेज रहे हैं"
   :object-pending                        "विचाराधीन"
   :object-sent                           "भेज दिया"
   :object-seen-by-everyone               "हर किसी ने देख लिया"
   :object-seen                           "देखा गया"
   :object-delivered                      "सौंप दिया"
   :object-failed                         "विफल रहा"
   ...
   :email                                 "ईमेल"
   :profile-no-object                     "कोई स्थिति नहीं"
   ...
   :intro-object                          "अपना खाता सेट करने और अपनी सेटिंग्स बदलने के लिए मेरे साथ चैट करें!"
   ...
   :recent                                "नया"
   :no-objectes-discovered                "कोई स्टेटस नहीं मिला"
   ...
   :debug-enabled                         "डीबग सर्वर लाँच कर दिया गया है! है। अब आप अपने कम्प्यूटर से *object-dev-cli scan* चलाकर अपने DApp को शामिल कर सकते हैं"
   ...
   :sign-in-to-object                     "स्टैटस में साइन इन करें"
   :got-it                                "समझ गया"
   ...
   :object-prompt                         "आप जिन चीजों की पेशकश कर रहे हैं उनके बारे में जानने में लोगों की मदद करने के लिए एक स्टैटस बनाएं। आप #हैशटैग्स का उपयोग भी कर सकते हैं।"
   :add-a-object                          "स्टैटस जोड़ें..."
   :error                                 "त्रुटि"
   :edit-contacts                         "संपर्कों का संपादन करें"
   :more                                  "अधिक"
   :cancel                                "रद्द करें"
   :no-objectes-found                     "कोई स्टैटस नहीं मिले"
   :swow-qr                               "QR दिखाएं"
