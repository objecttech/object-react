...
(def translations
  {
   ...
   ;messages
   :object-sending                        "שולח"
   :object-pending                        "ממתין"
   :object-sent                           "נשלחה"
   :object-seen-by-everyone               "פומבי"
   :object-seen                           "נראה"
   :object-delivered                      "התקבל"
   :object-failed                         "נכשל"
   ...
   :email                                 "אי-מייל"
   :update-object                         "...עדכן סטטוס"
   :add-a-object                          "...הוסף סטטוס"
   :object-prompt                         ".#hashtags צור סטטוס כדי ליידע אחרים בקשר לדברים אותם אתה מציע. אתה יכול גם להשתמש ב"
   ...
   :intro-object                          "דבר איתי כדי להסדיר את המשתמש שלך ולשנות את ההגדרות"
   ...
   :debug-enabled                         ".שרת הניפוי הותחל! אתה יכול כעת לבצע *object-dev-cli scan* כדי למצוא את השרת מהמחשב שלך על אותה הרשת"
   ...
   :recent                                "חדש"
   :no-objectes-discovered                "לא התגלה שום סטטוס"
   :no-objectes-found                     "לא נמצא שום סטטוס"
   ...
   :password                              "סיסמא"
   :login                                 "כניסה תלמערכת"
   :sign-in-to-object                     "התחבר לסטטוס"
   :sign-in                               "התחבר"
