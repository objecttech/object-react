...
(def translations
  {
   ...
   ;messages
   :object-sending                        "Se trimite"
   :object-pending                        "În așteptare"
   :object-sent                           "Trimis"
   :object-seen-by-everyone               "Văzut de toată lumea"
   :object-seen                           "Văzut"
   :object-delivered                      "Livrat"
   :object-failed                         "Eșuat"
   ...
   :email                                 "E-mail"
   :profile-no-object                     "Nici un object"
   ...
   :intro-object                          "Hai să vorbim pe chat pentru a-ți seta contul și modifica setările!"
   :intro-message1                        "Bine ai vent în Object\nApasă pe acest mesaj pentru a-ți seta parola și a începe!"
   ...
   :recent                                "Recente"
   :no-objectes-discovered                "Nici un object găsit"
   ...
   :debug-enabled                         "Serverul de curățare a fost lansat! Adresa dvs. Acum vă puteți adăuga DApp rulând *object-dev-cli scan* de pe computerul dvs."
   ...
   :sign-in-to-object                     "Conectați-vă cu objectul"
   :got-it                                "Am înțeles"
   ...
   :object-prompt                         "Creați un object pentru a-i ajuta pe ceilalți să afle ce anume oferiți. Puteți folosi și #hashtag-uri."
   :add-a-object                          "Adăugați un object..."
   :error                                 "Eroare"
   :edit-contacts                         "Editare contacte"
   :more                                  "mai mult"
   :cancel                                "Anulare"
   :no-objectes-found                     "Niciun object găsit"
   :swow-qr                               "Afișare QR"
