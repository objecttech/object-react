(ns objecttech.translations.es-mx)
...
(def translations
  {
   ...
   :camera-access-error                   "Para permitir el acceso a la cámara, porfavor, ve a configuración de sistema y asegúrate que la opción 'Object > Cámara' está seleccionada."
   :photos-access-error                   "Para permitir el acceso a fotos, porfavor, ve a configuración de sistema y asegúrate que la opción 'Object > Fotos' está seleccionada."
   ...
   :object-pending                        "Pendiente"
   :object-sent                           "Enviado"
   :object-seen-by-everyone               "Visto por todos"
   :object-seen                           "Visto"
   :object-delivered                      "Entregado"
   :object-failed                         "Fallido"
   ...
   :update-object                         "Actualizar tu estado..."
   :add-a-object                          "Agregar un estado..."
   :object-prompt                         "Crea un estado para informar a los demás lo que ofreces. También puedes usar #hashtags."
   ...
   :intro-object                          "¡Chatea conmigo para establecer tu cuenta y modificar tu configuración!"
   :intro-message1                        "¡Bienvenid@ a Object\nToca este mensaje para configurar tu contraseña y empezar!"
   ...
   :debug-enabled                         "¡El servidor de depuración ha sido lanzado! Ahora puedes ejecutar *object-dev-cli scan* para encontrar el servidor desde tu computadora en la misma red."
   ...
   :recent                                "Recientes"
   :no-objectes-discovered                "No se descubrieron estados"
   :no-objectes-found                     "No se encontraron estados"
   ...
   :sign-in-to-object                     "Regístrate a Object"
   :sign-in                               "Regístrate"
