...
(def translations
  {
   ...
   ;messages
   :object-sending                        "Відправлення"
   :object-pending                        "Очікує відправлення"
   :object-sent                           "Надіслано"
   :object-seen-by-everyone               "Переглянуто всіма"
   :object-seen                           "Переглянуто"
   :object-delivered                      "Доставлено"
   :object-failed                         "Помилка"
   ...
   :email                                 "Ел. пошта"
   :profile-no-object                     "Немає статусу"
   ...
   :intro-object                          "Спілкуйтеся зі мною, щоб налаштувати свій обліковий запис і змінити налаштування!"
   ...
   :recent                                "Нещодавні"
   :no-objectes-discovered                "Статусів не знайдено"
   ...
   :debug-enabled                         "Debug server запущено! Тепер ви можете додати свій DApp запустивши *object-dev-cli scan* зі свого комп’ютера"
   ...
   :sign-in-to-object                     "Увійти в Статус"
   :got-it                                "Зрозуміло"
   ...
   :object-prompt                         "Створіть статус, щоб допомогти людям дізнатись про речі, які ви пропонуєте. Можете також використовувати #хештеги."
   :add-a-object                          "Додати статус..."
   :error                                 "Збій"
   :edit-contacts                         "Редагувати контакти"
   :more                                  "ще"
   :cancel                                "Відмінити"
   :no-objectes-found                     "Статуси не знайдено"
   :swow-qr                               "Показати QR"
