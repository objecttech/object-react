...
(def translations
  {
   ...
   ;messages
   :object-sending                        "Đang gửi"
   :object-pending                        "Chưa giải quyết"
   :object-sent                           "Đã gửi"
   :object-seen-by-everyone               "Được nhìn thấy bởi mọi người"
   :object-seen                           "Đã nhìn thấy "
   :object-delivered                      "Đã gửi"
   :object-failed                         "Đã thất bại"
   ...
   :email                                 "Email"
   :profile-no-object                     "Không có trạng thái"
   ...
   :intro-object                          "Trò chuyện với tôi để thiết lập tài khoản của bạn và thay đổi các thiết lập của bạn!"
   ...
   :recent                                "Gần đây"
   :no-objectes-discovered                "Không có trạng thái được tìm thấy"
   ...
   :debug-enabled                         "Máy chủ gỡ lỗi đã được khởi chạy! Bạn có thể thêm DApp bằng cách chạy *object-dev-cli scan* từ máy tính của mình"
   ...
   :sign-in-to-object                     "Đăng nhập vào Trạng thái"
   :got-it                                "Đã hiểu"
   ...
   :object-prompt                         "Tạo trạng thái để giúp mọi người biết về những điều bạn đang cung cấp. Bạn cũng có thể sử dụng #hashtags."
   :add-a-object                          "Thêm trạng thái ..."
   :error                                 "Lỗi"
   :edit-contacts                         "Chỉnh sửa danh bạ"
   :more                                  "thêm"
   :cancel                                "Hủy"
   :no-objectes-found                     "Không tìm thấy trạng thái nào"
