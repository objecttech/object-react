...
(def translations
  {
   ...
   ;messages
   :object-sending                        "กำลังส่ง"
   :object-pending                        "อยู่ระหว่างดำเนินการ"
   :object-sent                           "ส่งแล้ว"
   :object-seen-by-everyone               "อ่านแล้วโดยทุกคน"
   :object-seen                           "อ่านแล้ว"
   :object-delivered                      "ส่งแล้ว"
   :object-failed                         "ล้มเหลว"
   ...
   :intro-object                          "แชทกับฉันเพื่อตั้งค่าบัญชีของคุณและเปลี่ยนการตั้งค่าของคุณ!"
   ...
   :no-objectes-discovered                "ไม่พบสถานะใด ๆ"
   ...
   :debug-enabled                         "มีการเปิดการดำเนินงานของเซิร์ฟเวอร์ที่ได้แก้ไขข้อบกพร่องแล้ว! ตอนนี้คุณสามารถเพิ่ม DApp ของคุณโดยการเปิดดำเนินการ *object-dev-cli scan* จากคอมพิวเตอร์ของคุณ"
   ...
   :sign-in-to-object                     "ลงชื่อเข้าใช้ในสถานะ"
   :got-it                                "เข้าใจแล้ว"
   ...
   :object-prompt                         "สร้างสถานะเพื่อช่วยให้ผู้คนได้รู้ถึงสิ่งที่คุณกำลังเสนอ คุณสามารถใช้ #hashtags ได้ด้วย"
   :add-a-object                          "เพิ่มสถานะ..."
   :error                                 "ข้อผิดพลาด"
   :edit-contacts                         "แก้ไขรายชื่อติดต่อ"
   :more                                  "เพิ่มเติม"
   :cancel                                "ยกเลิก"
   :no-objectes-found                     "ไม่พบสถานะ"
   :swow-qr                               "แสดง QR"
