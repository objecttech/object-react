...
(def translations
  {
   ...
   ;messages
   :object-sending                        "sendet..."
   :object-pending                        "wird zugestellt"
   :object-sent                           "Verschickt"
   :object-seen-by-everyone               "Von Allen gesehen"
   :object-seen                           "Gesehen"
   :object-delivered                      "Zugestellt"
   :object-failed                         "Fehlgeschlagen"
   ...
   :intro-object                          "Chatten Sie mit mir, um Ihren Account einzurichten und Ihre Einstellungen zu ändern!"
   :intro-message1                        "Willkommen bei Object.\nTippen Sie auf diese Nachricht, um Ihr Passwort einzurichten und loszulegen!"
   ...
   :recent                                "Kürzlich"
   :no-objectes-discovered                "Kein Object gefunden"
   ...
   :debug-enabled                         "Debug-Server wurde eingeführt! Sie können nun Ihre DApp hinzufügen, indem Sie *object-dev-cli scan* von Ihrem Computer starten"
   :share-qr                              "QR teilen"
   ...
   :sign-in-to-object                     "Zum Object anmelden"
   :got-it                                "Verstanden"
   ...
   :public-group-object                   "Öffentlich"
   ...
   :object-prompt                         "Erstellen Sie einen Object, um anderen Menschen zu helfen, über die Dinge zu erfahren, die Sie anbieten. Sie können auch #hashtags nutzen."
   :add-a-object                          "Einen Object hinzufügen ..."
   :edit-contacts                         "Kontakte bearbeiten"
   :more                                  "Mehr"
   :no-objectes-found                     "Keine Object gefunden"
   :swow-qr                               "QR anzeigen"
