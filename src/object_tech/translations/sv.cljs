...
(def translations
  {
   ...
   ;messages
   :object-sending                        "Skickar"
   :object-pending                        "Avvaktan"
   :object-sent                           "Skickad"
   :object-seen-by-everyone               "Sedd av alla"
   :object-seen                           "Sedd"
   :object-delivered                      "Levererad"
   :object-failed                         "Misslyckad"
   ...
   :intro-object                          "Chatta med mig för att konfigurera ditt konto och ändra dina inställningar!"
   :intro-message1                        "Välkommen till Object\nTryck på detta meddelande för att ställa in ditt lösenord och komma igång!"
   ...
   :recent                                "Senaste"
   :no-objectes-discovered                "Inga objectar upptäckta"
   ...
   :debug-enabled                         "Felsökningsserver startad! Lägg till din DApp genom att ange *object-dev-cli scan* på datorn"
   ...
   :sign-in-to-object                     "Logga in till Object"
   :got-it                                "Uppfattat"
   ...
   :object-prompt                         "Skapa en object så att personer vet vad du erbjuder. Du kan också använda #hashtaggar."
   :add-a-object                          "Lägg till object…"
   :error                                 "Fel"
   :edit-contacts                         "Redigera kontakter"
   :more                                  "mer"
   :cancel                                "Avbryt"
   :no-objectes-found                     "Inga objectar hittades"
   :swow-qr                               "Visa QR"
