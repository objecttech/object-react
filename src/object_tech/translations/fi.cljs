...
(def translations
  {
   ...
   :camera-access-error                   "Myöntääksesi vaadittu kameran käyttölupa, siirry järjestelmäasetuksiin ja varmista, että Object > Kamera on valittu."
   :photos-access-error                   "Myöntääksesi vaadittu kuvien käyttölupa, siirry järjestelmäasetuksiin ja varmista, että Object > Kuvat on valittu."
   ...
   ;messages
   :object-sending                        "Lähetetään"
   :object-pending                        "Odottaa"
   :object-sent                           "Lähetetty"
   :object-seen-by-everyone               "Kaikki nähneet"
   :object-seen                           "Nähty"
   :object-delivered                      "Toimitettu"
   :object-failed                         "Epäonnistui"
   ...
   :email                                 "Sähköposti"
   :update-object                         "Päivitä tila..."
   :add-a-object                          "Lisää tila..."
   :object-prompt                         "Luo tila, jonka avulla ihmiset tietävät mitä asioita tarjoat. Voit myös käyttää #hashtag-merkintöjä."
   ...
   :intro-object                          "Keskustele kanssani määrittääksesi tai muuttaaksesi tilisi asetuksia!"
   ...
   :debug-enabled                         "Debug-palvelin käynnistetty! Löytääksesi palvelimen suorita samaan verkkoon kuuluvalta tietokoneeltasi *object-dev-cli scan*."
   ...
   :recent                                "Uusimmat"
   :no-objectes-discovered                "Ei hakutuloksia"
   :no-objectes-found                     "Ei hakutuloksia"
   ...
   :password                              "Salasana"
   :login                                 "Kirjaudu"
   :sign-in-to-object                     "Luo Object -tili"
   :sign-in                               "Luo tili"
