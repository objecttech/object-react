...
(def translations
  {
   ...
   :camera-access-error                   "Om de kamera tastimming te jaan, gea nei dyn systeem ynstellings en wêz wis dat Object > Camera selektearre is."
   :photos-access-error                   "Om ús tastimming te jaan oan dyn foto's, gea nei dyn systeem ynstellings en wêz wis dat Object > Foto's selektearre is."
   ...
   ;messages
   :object-sending                        "Wurdt ferstjoerd "
   :object-pending                        "Yn behanneling"
   :object-sent                           "Ferstjoerd"
   :object-seen-by-everyone               "Troch eltsenien sjoen"
   :object-seen                           "Sjoen"
   :object-delivered                      "Besoarge"
   :object-failed                         "Mislearre"
   ...
   :email                                 "E-mailadres"
   :update-object                         "Fernij dyn object..."
   :add-a-object                          "Foegje in object ta..."
   :object-prompt                         "Foeg in object ta om oare minsken te litte witte wast do oanbiedest, do kinst ek #hashtags gebroeke."
   ...
   :intro-object                          "Chat mei my om dyn account yn te stellen en dyn ynstellingen te wizigjen!"
   :intro-message1                        "Wolkom by Object\nTik op dit berjocht om dyn wachtwurd yn te stellen en oan de slach te gean!"
   ...
   :debug-enabled                         "Debug server has been launched! You can now execute *object-dev-cli scan* to find the server from your computer on the same network."
   ...
   :recent                                "Koartlyn"
   :no-objectes-discovered                "Gjin objectsen ûntdutsen"
   :no-objectes-found                     "Gjin objectsen fûn"
   ...
   :password                              "Wachtwurd"
   :login                                 "Ynlogge"
   :sign-in-to-object                     "Oanmelde by Object"
   :sign-in                               "Ynlogge"
