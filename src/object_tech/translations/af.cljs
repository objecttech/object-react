...
(def translations
  {
   ...
   ;messages
   :object-sending                        "Besig om te stuur"
   :object-pending                        "Hangende"
   :object-sent                           "Gestuur"
   :object-seen-by-everyone               "Deur almal gesien"
   :object-seen                           "Gesien"
   :object-delivered                      "Afgelewer"
   :object-failed                         "Gefaal"
   ...
   :intro-object                          "Gesels met my om jou rekening op te stel en jou stellings te verander!"
   :intro-message1                        "Welkom by Object\nTik tik hierdie boodskap om jou wagwoord te stel & laat ons begin!"
   ...
   :recent                                "Onlangs"
   :no-objectes-discovered                "Geen objectse gevind nie"
   ...
   :debug-enabled                         "Ontfout-bediener is bekendgestel! U kan nou u DApp byvoeg deur *object-dev-cli scan* te hardloop vanaf u rekenaar"
   ...
   :sign-in-to-object                     "Teken aan op Object"
   :got-it                                "Het dit"
   ...
   :object-prompt                         "Skep ‘n object om te help dat mense weet oor die goed wat u aanbied. U kan #hutsmerke ook gebruik."
   :add-a-object                          "Voeg ‘n object by..."
   :error                                 "Fout"
   :edit-contacts                         "Redigeer kontakte"
   :more                                  "meer"
   :cancel                                "Kanselleer"
   :no-objectes-found                     "Geen objectse gevind nie"
   :swow-qr                               "Wys QR"
