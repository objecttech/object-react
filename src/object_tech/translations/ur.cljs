...
(def translations
  {
   ...
   ;messages
   :object-sending                        "بھیجا جا رہا ہے"
   :object-pending                        "زیر غور"
   :object-sent                           "بھیج دیا گیا"
   :object-seen-by-everyone               "ہر ایک نے دیکھ لیا ہے"
   :object-seen                           "دیکھ لیا گیا"
   :object-delivered                      "پہنچا دیا گیا"
   :object-failed                         "ناکام ہو گیا"
   ...
   :email                                 "ای میل"
   :profile-no-object                     "کوئی سٹیٹس نہیں"
   ...
   :intro-object                          "اپنا اکاؤنٹ سیٹ اپ کرنے اور سیٹنگز تبدیل کرنے کے لیے مجھ سے چیٹ کریں!"
   ...
   :recent                                "حالیہ"
   :no-objectes-discovered                "کوئی سٹیٹس نہیں پایا گیا"
   ...
   :debug-enabled                         "ڈی بگ سرور کو لانچ کیا گیا ہے! آپ کا آئی پتہ ہے۔ اب آپ اپنے کمپیوٹر سے *object-dev-cli scan* کو چلاتے ہوئے اپنا DApp شامل کر سکتے ہیں"
   ...
   :sign-in-to-object                     "اسٹیٹس میں سائن اِن کریں"
   :got-it                                "سمجھ گیا"
   ...
   :object-prompt                         "آپ کے ذریعہ پیشکش کی جانے والی چیزوں کے متعلق لوگوں کو جاننے میں مدد دینے کے لیے کوئی اسٹیٹس تخلیق کریں۔ آپ #ہیشٹیگ بھی استعمال کرسکتے ہیں۔"
   :add-a-object                          "کوئی اسٹیٹس شامل کریں..."
   :error                                 "خرابی"
   :edit-contacts                         "روابط کو حذف کریں"
   :more                                  "مزید"
   :cancel                                "منسوخ کریں"
   :no-objectes-found                     "کسی اسٹیٹس کا پتہ نہیں چلا"
