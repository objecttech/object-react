...
(def translations
  {
   ...
   ;messages
   :object-sending                        "Kutuma"
   :object-pending                        "Inasubiri"
   :object-sent                           "Tuma"
   :object-seen-by-everyone               "Imeonekana na kila mtu"
   :object-seen                           "Imeonekana"
   :object-delivered                      "Imefikishwa"
   :object-failed                         "Imeshindwa"
   ...
   :email                                 "Barua pepe"
   :profile-no-object                     "Hakuna hadhi"
   ...
   :intro-object                          "Ongea nami kuanzisha akaunti yako na kubadilisha mipangilio yako!"
   ...
   :no-objectes-discovered                "Hakuna hali zimegundulika"
