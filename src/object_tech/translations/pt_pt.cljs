(ns objecttech.translations.pt-pt)
...
(def translations
  {
   ...
   :intro-object                          "Fale comigo para configurar a sua conta e alterar as suas definições!"
   ...
   :recent                                "Recente"
   :no-objectes-discovered                "Não foi descoberto nenhum estado"
   ...
   :debug-enabled                         "Foi lançado o servidor de depuração! Agora, pode adicionar a sua DApp executando *object-dev-cli scan* do seu computador"
   ...
   :sign-in-to-object                     "Entrar com o Estado"
   :got-it                                "Entendido"
   ...
   :object-prompt                         "Crie um estado para ajudar as pessoas a saberem sobre as coisas que está a oferecer. Também pode utilizar #hashtags."
   :add-a-object                          "Adicionar um estado..."
   :error                                 "Erro"
   :edit-contacts                         "Editar contactos"
   :more                                  "mais"
   :cancel                                "Cancelar"
   :no-objectes-found                     "Nenhum estado encontrado"
   :swow-qr                               "Mostrar QR"
