(ns objecttech.translations.zh-hans)
...
(def translations
  {
   ...
   :object-pending                        "等待中"
   :object-sent                           "已发送"
   :object-seen-by-everyone               "所有人可见"
   :object-seen                           "可见"
   :object-delivered                      "已交付"
   :object-failed                         "失败"
   ...
   :phone-number                          "电话号码"
   :email                                 "电子邮件"
   :update-object                         "更新你的状态..."
   :add-a-object                          "添加状态..."
   :object-prompt                         "建立一个状态以帮助人们了解您提供的内容。 你也可以使用#hashtags。"
   ...
   :intro-object                          "跟我聊天，以设置你的帐户并更改你的设置！"
   :intro-message1                        "欢迎来到Object\n点击该消息，以设置你的密码并开始！"
   ...
   :debug-enabled                         "调试服务器已经推出！ 现在你可以执行* object-dev-cli scan *在同一网络上的电脑上查找服务器。"
   ...
   :popular-tags                          "热门标签"
   :recent                                "最近"
   :no-objectes-discovered                "未发现状态"
   :no-objectes-found                     "找不到状态"
