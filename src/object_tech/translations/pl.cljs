...
(def translations
  {
   ...
   ;messages
   :object-sending                        "Wysyłanie"
   :object-pending                        "W oczekiwaniu"
   :object-sent                           "Wysłano"
   :object-seen-by-everyone               "Przeczytane przez wszystkich"
   :object-seen                           "Przeczytane"
   :object-delivered                      "Dostarczono"
   :object-failed                         "Niepowodzenie"
   ...
   :email                                 "E-mail"
   :profile-no-object                     "Brak objectu"
   ...
   :intro-object                          "Porozmawiaj ze mną na czacie, aby skonfigurować swoje konto i zmienić ustawienia!"
   :intro-message1                        "Witamy w sekcji Object\nWybierz tę wiadomość, aby ustawić hasło i rozpocząć!"
   ...
   :recent                                "Najnowsze"
   :no-objectes-discovered                "Nie odkryto objectów"
   ...
   :debug-enabled                         "Uruchomiono serwer debugowania! Możesz teraz dodać program DApp, uruchamiając *object-dev-cli scan* na swoim komputerze"
   ...
   :sign-in-to-object                     "Zaloguj się do Objectu"
   :got-it                                "Rozumiem"
   ...
   :object-prompt                         "Utwórz object, aby inni mogli dowiedzieć się, co oferujesz. Możesz również wykorzystać #hashtagi."
   :add-a-object                          "Dodaj object..."
   :error                                 "Błąd"
   :edit-contacts                         "Edytuj kontakty"
   :more                                  "więcej"
   :cancel                                "Anuluj"
   :no-objectes-found                     "Nie znaleziono objectów"
   :swow-qr                               "Pokaż QR"
