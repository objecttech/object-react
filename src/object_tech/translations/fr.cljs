...
(def translations
  {
   ...
   :camera-access-error                   "Merci d'aller dans vos paramètres système et de vous assurer que Object > Caméra est sélectionné afin d'accorder la permission d'utiliser votre caméra."
   :photos-access-error                   "Merci d'aller dans vos paramètres système et de vous assurer que Object > Photos est sélectionné afin d'accorder la permission d'utiliser vos photos."
   ...
   ;messages
   :object-sending                        "Envoi en cours..."
   :object-pending                        "En attente..."
   :object-sent                           "Envoyé"
   :object-seen-by-everyone               "Vu par tout le monde"
   :object-seen                           "Vu"
   :object-delivered                      "Délivré"
   :object-failed                         "Échec"
   ...
   :update-object                         "Actualisez votre statut..."
   :add-a-object                          "Ajoutez un statut..."
   :object-prompt                         "Créez un nouveau statut pour partager vos intérêts avec tout le monde. Vous pouvez aussi utiliser les #hashtags."
   ...
   :intro-object                          "Chattez avec moi pour configurer votre compte et modifier vos paramètres !"
   :intro-message1                        "Bienvenue dans Object\nTapez sur ce message pour définir votre mot de passe et commencer !"
   ...
   :debug-enabled                         "Le serveur Debug a été lancé! Vous pouvez désormais utiliser *object-dev-cli scan* pour trouver le serveur depuis votre ordinateur sur le même réseau."
   ...
   :recent                                "Récent"
   :no-objectes-discovered                "Aucun statut découvert"
   :no-objectes-found                     "Aucun statut trouvé"
   ...
   :login                                 "Connexion"
   :sign-in-to-object                     "S'inscrire à Object"
   :sign-in                               "Inscription"
