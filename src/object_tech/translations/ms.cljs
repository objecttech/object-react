...
(def translations
  {
   ...
   :camera-access-error                   "Untuk memberi keizinan akses kamera yang diperlukan, sila pergi ke aturan sistem anda dan pastikan bahawa Object > Kamera telah dipilih."
   :photos-access-error                   "Untuk memberi keizinan akses gambar yang diperlukan, sila pergi ke aturan sistem anda dan pastikan bahawa Object > Gambar telah dipilih."
   ...
   ;messages
   :object-sending                        "Menghantar"
   :object-pending                        "Belum selesai"
   :object-sent                           "Dihantar"
   :object-seen-by-everyone               "Dilihat oleh semua"
   :object-seen                           "Dilihat"
   :object-delivered                      "Dihantar"
   :object-failed                         "Gagal"
   ...
   :email                                 "Emel"
   :update-object                         "Kemaskini object anda..."
   :add-a-object                          "Tambah pada object..."
   :object-prompt                         "Ciptakan satu object untuk membantu pengguna lain mengetahui tentang perkara yang anda tawarkan. Anda juga boleh menggunakan #hashtag. "
   ...
   :intro-object                          "Mulakan perbualan dengan saya untuk mencipta akaun anda dan mengubah aturan akaun anda!"
   :intro-message1                        "Selamat datang ke Object\nSila sentuh mesej ini untuk menetapkan kata lalaun & memulakan!"
   ...
   :debug-enabled                         "Debug server telah dijalankan! Sekarang anda boleh menjalankan *object-dev-cli scan* untuk mecari sambungan server dari komputer anda dalam jaringan yang sama."
   ...
   :recent                                "Terbaru"
   :no-objectes-discovered                "Tiada object ditemui"
   :no-objectes-found                     "Tiada object ditemui"
   ...
   :login                                 "Daftar masuk"
   :sign-in-to-object                     "Daftar masuk ke Object"
