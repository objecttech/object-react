...
(def translations
  {
   ...
   :camera-access-error                   "Om cameratoegang te geven, ga je naar systeem instellingen en zorg je dat Object > Camera geselecteerd is."
   :photos-access-error                   "Om fototoegang te geven, ga je naar systeem instellingen en zorg je dat Object > Foto's geselecteerd is."
   ...
   ;messages
   :object-sending                        "Wordt verstuurd"
   :object-pending                        "Hangende"
   :object-sent                           "Verstuurd"
   :object-seen-by-everyone               "Door iedereen gezien"
   :object-seen                           "Gezien"
   :object-delivered                      "Bezorgd"
   :object-failed                         "Mislukt"
   ...
   :email                                 "E-mailadres"
   :update-object                         "Wijzig je object..."
   :add-a-object                          "Voeg een object toe..."
   :object-prompt                         "Maak een object aan om mensen te laten weten wat je te bieden hebt. Je kan ook #hashtags gebruiken."
   ...
   :intro-object                          "Chat met me om jouw account in te stellen en jouw instellingen te wijzigen!"
   :intro-message1                        "Welkom bij Object\nTik op dit bericht om jouw wachtwoord in te stellen en aan de slag te gaan!"
   ...
   :debug-enabled                         "Debug-server is gelanceerd! Je kan nu *object-dev-cli scan* uitvoeren om de server te vinden vanaf je computer op het zelfde netwerk."
   ...
   :recent                                "Recent"
   :no-objectes-discovered                "Geen objectsen ontdekt"
   :no-objectes-found                     "Geen objectsen gevonden"
   ...
   :password                              "Wachtwoord"
   :login                                 "Inloggen"
   :sign-in-to-object                     "Meld u aan bij Object"
   :sign-in                               "Meld aan"
