(ns objecttech.components.chat-icon.styles
...
(defn default-chat-icon-message-object [color]
  (merge (default-chat-icon color)
         {:width         64
          :height        64
          :border-radius 32}))
