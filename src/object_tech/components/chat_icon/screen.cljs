(ns objecttech.components.chat-icon.screen
  ...
  (:require [re-frame.core :refer [subscribe dispatch]]
            [objecttech.components.react :refer [view
                                                ...
                                                image
                                                icon]]
            [objecttech.components.chat-icon.styles :as st]
            [objecttech.components.styles :refer [default-chat-color]]
            [objecttech.react-native.resources :as resources]
...
(defn chat-icon-message-object [chat-id group-chat name color online]
  ^{:key chat-id}
  [chat-icon-view chat-id group-chat name online
   {:container              st/container-message-object
    :online-view-wrapper    st/online-view-wrapper
    :online-view            st/online-view
    :online-dot-left        st/online-dot-left
    :online-dot-right       st/online-dot-right
    ...
    :pending-inner-circle   st/pending-inner-circle
    :size                   64
    :chat-icon              st/chat-icon-message-object
    :default-chat-icon      (st/default-chat-icon-message-object color)
    :default-chat-icon-text st/message-object-icon-text}])
