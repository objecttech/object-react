(ns objecttech.components.toolbar-new.view
  (:require [re-frame.core :refer [subscribe dispatch]]
            [objecttech.components.react :refer [view
                                                ...
                                                image
                                                touchable-highlight]]
            [objecttech.components.sync-state.gradient :refer [sync-state-gradient-view]]
            [objecttech.components.styles :refer [icon-default
                                                 icon-search
                                                 color-gray4]]
            [objecttech.components.context-menu :refer [context-menu]]
            [objecttech.components.toolbar-new.actions :as act]
            [objecttech.components.toolbar-new.styles :as st]
