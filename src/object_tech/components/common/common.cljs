(ns objecttech.components.common.common
  (:require [objecttech.components.react :refer [view text icon linear-gradient]]
            [objecttech.components.context-menu :refer [context-menu]]
            [objecttech.utils.platform :as p]
            [objecttech.components.common.styles :as st]))
