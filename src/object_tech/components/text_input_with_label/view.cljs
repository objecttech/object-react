(ns objecttech.components.text-input-with-label.view
  (:require [reagent.core :as r]
            [objecttech.components.animation :as animation]
            [objecttech.components.text-input-with-label.animation :refer [animate-label
                                                                          text-input-on-focus
                                                                          text-input-on-blur]]
            [objecttech.components.react :refer [view
                                                ...
                                                animated-view
                                                text-input]]
            [objecttech.components.text-input-with-label.styles :as st]
