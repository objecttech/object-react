(ns objecttech.profile.qr-code.screen
  (:require-macros [objecttech.utils.views :refer [defview]])
  (:require [objecttech.components.react :refer [view
                                                text
                                                image
                                                icon
                                                touchable-highlight
            ...
            [objecttech.components.styles :refer [icon-close]]
            [objecttech.components.qr-code :refer [qr-code]]
            [re-frame.core :refer [dispatch subscribe]]
            [objecttech.profile.qr-code.styles :as st]
