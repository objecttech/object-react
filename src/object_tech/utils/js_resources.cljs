(ns objecttech.utils.js-resources
  (:require-macros [objecttech.utils.slurp :refer [slurp slurp-bot]])
  (:require [objecttech.utils.types :refer [json->clj]]
            [clojure.string :as s]))
...
(def object-js (str (slurp "resources/object.js")
