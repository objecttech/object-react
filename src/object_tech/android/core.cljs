(ns objecttech.android.core
  (:require [reagent.core :as r :refer [atom]]
            [re-frame.core :refer [subscribe dispatch dispatch-sync]]
            [objecttech.handlers]
            [objecttech.subs]
            [objecttech.specs]
            [objecttech.components.react :refer [app-registry
                                                app-state
                                                keyboard
                                                orientation
                                                back-android
            ...
            [objecttech.components.context-menu :refer [menu-context]]
            ...
            [objecttech.components.styles :as st]
            [objecttech.chat.styles.screen :as chat-st]
...
(defn init []
  ...
  (object/set-soft-input-mode object/adjust-resize)
